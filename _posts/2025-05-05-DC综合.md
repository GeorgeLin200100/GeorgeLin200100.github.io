...
# 时钟定义create_generated_clock

内容来自https://www.cnblogs.com/lelin/p/12652063.html
...
![img](../images/2025-05-05-DC%E7%BB%BC%E5%90%88.assets/1735380-20200407100815912-1243487483.png)
...
![img](../images/2025-05-05-DC%E7%BB%BC%E5%90%88.assets/1735380-20200407103047111-1860093815.png)
...
![img](../images/2025-05-05-DC%E7%BB%BC%E5%90%88.assets/1735380-20200407103542914-924033547.png)
...
![img](../images/2025-05-05-DC%E7%BB%BC%E5%90%88.assets/1735380-20200407104322066-1157067146.png)
...
![img](../images/2025-05-05-DC%E7%BB%BC%E5%90%88.assets/1735380-20200407104434477-1217970743.png)
...
![img](../images/2025-05-05-DC%E7%BB%BC%E5%90%88.assets/1735380-20200407105139076-1957705264.png)
...
# DC综合中的target_library和link_library的区别是什么

1、目标库（target_library）：一般就是std cell db；放的是标准单元工艺库； 是你的综合目的库，存放的是你索要映射的逻辑单元。一般为standard cell library & io cell library 的type；是DC在mapping时将设计映射到特定工艺所使用的库，就是使用目标库中的元件综合成设计的门级网表。
...
└── folder
    ...
    └── test.v
##############################################################################
dc_shell> set_app_var search_path "/home/zhangchen/Desktop/folder/" # 设置搜索路径（绝对路径）
dc_shell> read_file -format verilog test.v         # 简单路径，相对搜索路径
dc_shell> read_file -format verilog ./test2.v      # 相对路径，相对当前目录
dc_shell> read_file -format verilog ../test1.v     # 相对路径，相对当前目录的父目录

dc_shell> set_app_var search_path "./folder1/"     # 设置搜索路径（相对路径）
dc_shell> read_file -format verilog test1.v        # 简单路径，相对搜索路径

dc_shell> cd ..                                    # 将当前目录切换到folder1
dc_shell> set_app_var search_path "folder2/"       # 设置搜索路径（相对路径，省略./）
dc_shell> read_file -format verilog test2.v        # 简单路径，相对搜索路径
dc_shell> read_file -format verilog test1.v        # 这会导致错误，如果search_path不为空，简单路径不被当作是相对于当前目录而是相对搜索路径
————————————————
版权声明：本文为CSDN博主「日晨难再」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/weixin_45791458/article/details/143085356